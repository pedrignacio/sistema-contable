  ...
  return (
    <div className="mb-8 p-6 bg-linear-to-r from-emerald-500 to-teal-600 rounded-lg text-white shadow-lg">
      ...
      <div className="mt-6 flex gap-4">
        <button className="bg-white text-emerald-700 px-4 py-2 rounded font-medium hover:bg-emerald-50">
          Ver Carpeta Tributaria
        </button>
        <button className="bg-emerald-700 text-white px-4 py-2 rounded font-medium border border-emerald-400 hover:bg-emerald-800">
